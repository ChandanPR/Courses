...
public class Client {
    ...
    public static void main(String[] args) {
		...
		new ObjectName(domain +":type=jmx.connectors.SimpleStandard,name=2");
            echo("\nCreate SimpleStandard MBean...");
            mbsc.createMBean("jmx.connectors.SimpleStandard", stdMBeanName, null, null);
	    waitForEnterPressed();

            // Create SimpleDynamic MBean
            //
            ObjectName dynMBeanName =
		new ObjectName(domain +":type=jmx.connectors.SimpleDynamic,name=2");
            echo("\nCreate SimpleDynamic MBean...");
            mbsc.createMBean("jmx.connectors.SimpleDynamic", dynMBeanName, null, null);
	    waitForEnterPressed();
